...
root_dir = '/home/chen/Downloads/ChinaVisual/province_data_group'
output_dir = '/home/chen/Downloads/ChinaVisual/data_group_province'
    ...
    for csv_file in os.listdir(province_folder_path):
        if csv_file.endswith('.csv'):
            ...
            for index, row in df.iterrows():
                ...
                date = row['date']
                new_csv_file_path = os.path.join(output_dir, f'{date}.csv')
